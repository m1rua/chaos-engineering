...
result = stream(v1.connect_get_namespaced_pod_exec, namespace=namespace, name=autoscale_pod_name, command=http_script, stderr=True, stdin=False, stdout=True, tty=False)
print(result)